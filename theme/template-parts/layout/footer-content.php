...
<div class="w-full  h-full sm:flex bg-black justify-between border-b border-opacity-25 border-white">
	<div class="sm:w-1/3 ml-10">
		<img src="https://thebmegroup.com/wp-content/themes/bme/img/logo.png" alt="footer-logo" class="w-28 h-8 sm:mt-5">
	</div>
	<div class="sm:w-2/3 mx-10">
		<div class="sm:flex sm:space-x-5 space-y-2 sm:space-y-0 sm:text-center items justify-start sm:items-center pt-3 ">
			<p class="text-white font-light text-xs sm:text-sm uppercase whitespace-nowrap">subscribe to our newsletter</p>
			<div class=" border-white border flex p-1 relative w-full justify-between">
				...
				<button class="flex space-x-2 group">
					<p class="group-hover:pr-3 transition-all text-sm text-white">Subscribe</p>
