...
<div class="w-full flex bg-black justify-between border-b border-opacity-25 border-white">
	<div class="w-1/3 ">
		<img src="https://thebmegroup.com/wp-content/themes/bme/img/logo.png" class="w-28 h-8 mt-5 ml-10">
	</div>
	<div class="w-2/3">
		<div class="flex space-x-5 text-center items-center pt-3 mr-16">
		...
		<div class="flex text-center items-center py-6 justify-between mr-16">
			<p class="text-white font-extrabold text-sm uppercase">follow us</p>
...
<div class="w-full py-6 bg-black ">
	<p class="text-md font-light text-white ml-10">
